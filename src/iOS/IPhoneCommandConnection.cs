...
{
	public abstract class IPhoneCommandConnection : IDisposable
	{
	...
	class IPhoneTcpCommandConnection : IPhoneCommandConnection
	{
		Socket wifiListener;
